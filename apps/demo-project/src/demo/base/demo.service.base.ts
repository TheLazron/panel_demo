...
import { Prisma, Demo as PrismaDemo } from "@prisma/client";

export class DemoServiceBase {
  constructor(protected readonly prisma: PrismaService) {}

  async count(args: Omit<Prisma.DemoCountArgs, "select">): Promise<number> {
